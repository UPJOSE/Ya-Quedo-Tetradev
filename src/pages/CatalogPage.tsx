          ...
          <div className="flex items-center gap-3 relative">
            {user ? (
              ...
              <div className="flex items-center gap-2">
                <Link to="/login" className="text-sm font-medium text-text hover:text-primary transition-colors px-4 py-2">
                  Iniciar sesión
                </Link>
                <Link to="/register" className="bg-primary hover:bg-primary/90 text-white font-semibold px-4 py-2 rounded-xl text-sm transition-colors">
                  Registrarse
                </Link>
              </div>
            )}
